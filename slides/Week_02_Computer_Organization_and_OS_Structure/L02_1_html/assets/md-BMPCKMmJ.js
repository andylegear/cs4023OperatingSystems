import{E as e,H as t,R as n,S as r,X as i,_ as a,_t as o,g as s,ht as c,x as l}from"./modules/shiki-Dm5aQrj-.js";import{et as u,tt as d}from"./index-DZmyS2Vm.js";import{t as f}from"./default-DyN01U9c.js";var p={__name:`L02_1_Computer_System_Organization.md__slidev_15`,setup(p){let{$slidev:m,$nav:h,$clicksContext:g,$clicks:_,$page:v,$renderContext:y,$frontmatter:b}=d();return g.setup(),(d,p)=>{let m=t(`CodeBlockWrapper`);return n(),a(f,o(e(c(u)(c(b),14))),{default:i(()=>[p[1]||=s(`h1`,null,`Worked Example: Keyboard Interrupt Step-by-Step`,-1),p[2]||=s(`p`,null,[s(`strong`,null,`Scenario`),l(`: user presses the 'A' key in a terminal session.`)],-1),r(m,{title:``,ranges:[]},{default:i(()=>[...p[0]||=[s(`pre`,{class:`shiki shiki-themes vitesse-dark vitesse-light slidev-code`,style:{"--shiki-dark":`#dbd7caee`,"--shiki-light":`#393a34`,"--shiki-dark-bg":`#121212`,"--shiki-light-bg":`#ffffff`}},[s(`code`,{class:`language-text`},[s(`span`,{class:`line`},[s(`span`,null,`1. Key press detected by keyboard controller (Intel 8042 or USB HID)`)]),l(`
