import{E as e,H as t,R as n,S as r,X as i,_ as a,_t as o,g as s,ht as c,x as l}from"./modules/shiki-Dm5aQrj-.js";import{et as u,tt as d}from"./index-Bsilq7PL.js";import{t as f}from"./default-jxZuMhdL.js";var p={__name:`L11_2_File_Systems_Concepts_and_Implementation.md__slidev_14`,setup(p){let{$slidev:m,$nav:h,$clicksContext:g,$clicks:_,$page:v,$renderContext:y,$frontmatter:b}=d();return g.setup(),(d,p)=>{let m=t(`CodeBlockWrapper`);return n(),a(f,o(e(c(u)(c(b),13))),{default:i(()=>[p[2]||=s(`h1`,null,`Worked Example — inode Block Traversal`,-1),p[3]||=s(`p`,null,[s(`strong`,null,`File system:`),l(` 4 KB blocks, 4-byte block pointers → 1024 pointers per indirect block.`),s(`br`),s(`strong`,null,`File size:`),l(` 15 data blocks total.`)],-1),r(m,{title:``,ranges:[]},{default:i(()=>[...p[0]||=[s(`pre`,{class:`shiki shiki-themes vitesse-dark vitesse-light slidev-code`,style:{"--shiki-dark":`#dbd7caee`,"--shiki-light":`#393a34`,"--shiki-dark-bg":`#121212`,"--shiki-light-bg":`#ffffff`}},[s(`code`,{class:`language-text`},[s(`span`,{class:`line`},[s(`span`,null,` Inode block layout:`)]),l(`
